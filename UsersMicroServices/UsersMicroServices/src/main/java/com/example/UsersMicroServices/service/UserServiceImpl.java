...
import com.example.UsersMicroServices.config.JwtUtil;
...
public class UserServiceImpl implements UserService{
   ...
   //resttamplate
    ...
    public SuccessfulLoginDTO login(AuthDTO auth) throws ApiExceptionResponse {
        ...
        // Create and return SuccessfulLoginDTO with token
    ...
    public SuccessfulLogoutDTO logout(LogoutDTO dto) throws ApiExceptionResponse {
        ...
        // Extract token from the current security context
    ...
    private String getCurrentToken() {
        // Extract the token from the SecurityContext or Authorization header
